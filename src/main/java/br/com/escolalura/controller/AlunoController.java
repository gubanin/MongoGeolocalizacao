...
import br.com.escolalura.service.GeolocalizacaoService;
...
public class AlunoController {
	...
	public String salvar(@ModelAttribute Aluno aluno) {
		...
		try {
			List<Double> obterLateLongpor = geolocalizacaoService.obterLateLongpor(aluno.getContato());
			aluno.getContato().setCoordinates(obterLateLongpor);
